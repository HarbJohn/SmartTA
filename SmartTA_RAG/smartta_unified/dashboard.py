...
def render_instructor_dashboard() -> None:
    ...
    # Show course feedback summary at the top
    st.markdown("---")
    ...
    with tab_unclear:
        ...
        if unclear.empty:
            ...
            st.dataframe(unclear, width="stretch")
    with tab_lowconf:
    ...
    try:
        ...
        if text_data.strip():
            ...
            st.image(wc.to_array(), caption="Top keywords from student questions", width="stretch")
        else:
